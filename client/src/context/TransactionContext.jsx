...
export const TransactionsProvider = ({ children }) => {
  ...
  const demTransactionsContract = createEthereumContract()
  ...
  const uploadFiles = async () => {
    try {
      if (ethereum) {
        ...
        const documentHash = ['0xHash1', '0xHash2','0xHash3',];
 
        // const tx = await transactionsContract.uploadDocument(['0xHash1', '0xHash2','0xHash3']);
        // await tx.wait();
        ...
        console.log("No ethereum object in try");
      }
    } catch (error) {
      console.log(error);

      throw new Error("No ethereum object in catch");
    }
  };
